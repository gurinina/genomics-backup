...
For our examples we will focus on RNA-seq as it is the most manageable computationally as opposed to methylation, Chip-chip and DNA variant analysis. Its also, one of the more frequently used technologies in research, likely for this reason.
        ...
        added by them:   BAM/ERR458501.bam.indel.vcf
  =
        added by them:   FASTQ/.DS_Store
        added by them:   FASTQ/ERR458493.fastq
        added by them:   FASTQ/ERR458493.fastq.gz
        added by them:   FASTQ/ERR458494.fastq.gz
        added by them:   FASTQ/ERR458495.fastq.gz
        added by them:   FASTQ/ERR458500.fastq.gz
        added by them:   FASTQ/ERR458501.fastq.gz
        added by them:   FASTQ/ERR458502.fastq.gz
        added by them:   FASTQ/Saccharomyces_cerevisiae.R64-1-1.96.gtf
        added by them:   FASTQ/Saccharomyces_cerevisiae.R64-1-1.96.gtf.gz
        added by them:   FASTQ/multiqc_data/multiqc.log
        added by them:   FASTQ/multiqc_data/multiqc_citations.txt
        added by them:   FASTQ/multiqc_data/multiqc_data.json
        added by them:   FASTQ/multiqc_data/multiqc_fastqc.txt
        added by them:   FASTQ/multiqc_data/multiqc_general_stats.txt
        added by them:   FASTQ/multiqc_data/multiqc_sources.txt
        added by them:   FASTQ/multiqc_data_1/multiqc.log
        added by them:   FASTQ/multiqc_data_1/multiqc_citations.txt
        added by them:   FASTQ/multiqc_data_1/multiqc_data.json
        added by them:   FASTQ/multiqc_data_1/multiqc_fastqc.txt
        added by them:   FASTQ/multiqc_data_1/multiqc_general_stats.txt
        added by them:   FASTQ/multiqc_data_1/multiqc_sources.txt
        added by them:   FASTQ/multiqc_data_2/multiqc.log
        added by them:   FASTQ/multiqc_data_2/multiqc_citations.txt
        added by them:   FASTQ/multiqc_data_2/multiqc_data.json
        added by them:   FASTQ/multiqc_data_2/multiqc_fastqc.txt
        added by them:   FASTQ/multiqc_data_2/multiqc_general_stats.txt
        added by them:   FASTQ/multiqc_data_2/multiqc_snippy.txt
        added by them:   FASTQ/multiqc_data_2/multiqc_sources.txt
        added by them:   FASTQ/multiqc_report.html
        added by them:   FASTQ/multiqc_report_1.html
        added by them:   FASTQ/multiqc_report_2.html
        added by them:   FASTQ/myBAM_filtered.bam
        added by them:   FASTQ/r64/Saccharomyces_cerevisiae.R64-1-1.96.gtf.gz
        added by them:   FASTQ/r64/Saccharomyces_cerevisiae.R64-1-1.dna.toplevel.fa
        added by them:   FASTQ/r64/Saccharomyces_cerevisiae.R64-1-1.dna.toplevel.fa.fai
        added by them:   FASTQ/r64/Saccharomyces_cerevisiae.R64-1-1.dna.toplevel.fa.gz
        added by them:   FASTQ/r64/r64bread.index.00.b.array
        added by them:   FASTQ/r64/r64bread.index.00.b.tab
        added by them:   FASTQ/r64/r64bread.index.files
        added by them:   FASTQ/r64/r64bread.index.log
        added by them:   FASTQ/r64/r64bread.index.reads
        added by them:   FASTQ/subreadMapping.sh
        added by us:     RNA-genomics/01-reads2counts.Rmd
        added by us:     RNA-genomics/02-bamfiles.Rmd
        added by them:   css/style.css
        added by them:   css/toc.css
        both added:      figures/DESeq2_normalization.png
        both added:      figures/DESeq2_step1.png
        both added:      figures/DESeq2_step2.png
        both added:      figures/RNA-seq-analysis-flow-chart-An-example-RNA-seq-analysis-workflow-is-depicted-for-a.png
        both added:      figures/RNAseq_workflow.png
        both added:      figures/count-matrix.png
        both added:      figures/count_modes.png
        both added:      figures/countingreads_fc.png
        both added:      figures/counts-workflow.png
        both added:      figures/f1000research-4-7573-g0000.jpeg
        both added:      figures/featurecount_ambiguous.png
        both added:      figures/gtf.png
        both added:      figures/multioverlap.png
        both added:      figures/rnaseq_workflow2.png
        both added:      figures/rnaseqpipeline.png
        both added:      figures/union.png
        both added:      figures/variant_calling_workflow_cleanup.png
        both added:      figures/workflow_DESeq2.png
        both added:      figures/workflow_gene_quant.png
        deleted by us:   rna-genomics/_bookdown.yml
        deleted by us:   rna-genomics/_output.yml
        deleted by us:   rna-genomics/aln.bam
        both deleted:    rna-genomics/bamfiles.Rmd
        deleted by us:   rna-genomics/index.Rmd
        both deleted:    rna-genomics/reads2counts.Rmd
        both deleted:    rna-genomics/style.css
        added by us:     wrangling-genomics/css/style.css
