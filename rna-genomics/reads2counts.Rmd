...
[here](https://github.com/gurinina/omic_sciences/blob/main/08-NGS-pipeline.Rmd). Navigate to your FASTQ directory:
...
```{bash}
echo "arch" > build.sh
bash | arch -x86_64 /bin/bash ./build.sh
source $HOME/miniconda3-intel/bin/activate
conda activate rnaseq
fastqc FASTQ/ERR458493.gz -t 4 -o FASTQC
```
...
subread-buildindex -o r64bread.index Saccharomyces_cerevisiae.R64-1-1.dna.toplevel.fa.gz
...
subread-align --sortReadsByCoordinates -a FASTQ/r64/Saccharomyces_cerevisiae.R64-1-1.96.gtf.gz -B 3 -T 5 -i FASTQ/r64/r64bread.index -t 0 -r FASTQ/ERR458493.fastq.gz -o BAM/res458493.bam &> BAM/R493.log
...
featureCounts -O -t gene -g gene_id -a Saccharomyces_cerevisiae.R64-1-1.96.gtf -o counts.txt BAM/*.bam
