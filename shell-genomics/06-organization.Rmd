...
knitr::opts_chunk$set(engine.opts = list(bash="--init-file ~/.bashrc -i", zsh = '/bin/zsh'))
...
Then run your workshop log file as a zsh script. You should see the `dc_workshop`
